// Immediate cleanup - run once to clear all test data
...
async function immediateCleanup() {
  ...
  try {
    ...
    console.log(`Connecting to: ${DB_HOST}:${DB_PORT || 3306}/${DB_NAME}`);
    ...
    console.log('\n🔄 Cleaning ALL test data from database...\n');
    ...
    console.log('\nAll test data has been removed. Database is ready for real clients.');
